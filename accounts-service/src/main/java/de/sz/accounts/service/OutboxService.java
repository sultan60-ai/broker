...
public class OutboxService {
  ...
  @Transactional
  public OutboxEvent enqueueAccountEvent(String accountId, String eventType, Map<String, Object> payload) {
    try {
      String json = objectMapper.writeValueAsString(payload);

      OutboxEvent evt = new OutboxEvent();
      evt.setAggregateType("ACCOUNT");
      evt.setAggregateId(accountId);
